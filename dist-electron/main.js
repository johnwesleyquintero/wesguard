...
function Ks() {
  if (
    st.type() === "Windows_NT" &&
    !Bt &&
    ((Bt = dr + "\\system32\\wbem\\wmic.exe"), !ze.existsSync(Bt))
  )
    try {
...
function al() {
  ...
  if (gn || De)
    try {
      t = An("hostname -f 2>/dev/null", G.execOptsLinux)
        .toString()
        .split(We.EOL)[0];
    } catch {
      G.noop();
  ...
  if (be)
    try {
      t = An("echo %COMPUTERNAME%.%USERDNSDOMAIN%", G.execOptsWin)
        .toString()
  ...
  return new Promise((n) => {
    process.nextTick(() => {
      ...
      if (xi || an || ln || cn) {
        ...
        const s = [];
        (s.push(Kn(i)),
          s.push(Kn("export LC_ALL=C; dmidecode -t memory 2>/dev/null")),
...
`)
      ...
      if (Si) {
        const s = [];
        (s.push(Kn("ioreg -c IOPlatformExpertDevice -d 2")),
          s.push(Kn("system_profiler SPMemoryDataType")),
          I.promiseAll(s).then((r) => {
            let o = r.results[0]
...
`)),
                ...
                ((on = e.speed),
                  ...
                  (e = Xn(e)),
                  (e.vendor = si(P.getValue(r, "vendor id"))),
...
`)));
                ...
                ((on = e.speed),
                  ...
                  (e = Xn(e)),
                  (e.vendor = si(P.getValue(r, "manufacturer"))));
...
`);
              ...
              if (!i.length) {
                ...
                try {
                  let o = oi("cat /proc/cpuinfo 2>/dev/null", A.execOptsLinux),
                    a = o.toString().split(`
`),
...
`)));
        ...
        no &&
          Tn("system_profiler SPMemoryDataType", function (s, r) {
            if (!s) {
              const o = r.toString().split(`
`),
...
`);
        ...
        if (
          ((bl || Vl || Nl) &&
            Kr("sysctl -i hw.acpi.battery hw.acpi.acline", function (i, s) {
              let r = s.toString().split(`
`);
              const o = parseInt(
      ...
      try {
        const p = B.WINDIR + "\\System32\\DriverStore\\FileRepository",
          m = qn
            .readdirSync(p)
            .filter((h) =>
              qn.readdirSync([p, h].join("/")).includes("nvidia-smi.exe"),
            )
            .reduce((h, y) => {
              const g = qn.statSync([p, h, "nvidia-smi.exe"].join("/")),
                x = qn.statSync([p, y, "nvidia-smi.exe"].join("/"));
            ...
            .then((y) => {
              ...
              (T.forEach((L) => {
                ...
                d.displays.length === 1 &&
                  ...
                  Jn && (d.displays[0].pixelDepth = Jn)),
                (d.displays = d.displays.map(
                  (L) => (
                    Qn && !L.currentRefreshRate && (L.currentRefreshRate = Qn),
                    L
                  ),
                )),
                t && t(d),
...
`),
        ...
        (h.push({
          ...
          (Qn = B.toInt(B.getValue(g, "CurrentRefreshRate", ":")) || Qn),
          (Jn = B.toInt(B.getValue(g, "CurrentBitsPerPixel", ":")) || Jn));
      }
    return h;
  }
...
`);
        ...
        Ve &&
          Jr.readFile("/proc/sys/fs/file-nr", function (i, s) {
            if (i)
...
`,
    ...
    if (Qe || St || wt || Ct || ts) {
      ...
      (Je && (s = "ip route 2> /dev/null | grep default | awk '{print $5}'"),
        ...
        (St || wt || Ct || ts) && (s = "route get 0.0.0.0 | grep interface:"),
...
`)),
                    ...
                    ((c = parseInt(y[C + 5])),
                      ...
                      (p = parseInt(y[C + 10])),
                      (d = parseInt(y[C + 7])),
                      (o = Zn(i, c, u, o.operstate, l, f, p, d)));
                  }
                  e(o);
                }));
            })),
          ...
          M.powerShell(
            ...
            Sr(!1).then((C) => {
              ((c = 0),
                ...
                c && u && (o = Zn(x, parseInt(c), parseInt(u), a, l, f, p, d)),
                e(o));
            });
          });
        }
      ...
      if ((fe.ms && Date.now() - fe.ms >= 500) || fe.ms === 0)
        if (Ke || Bn || kn || Fn || Rt || ei)
          (Ke &&
            ...
            Vn(c, { maxBuffer: 1024 * 2e4 }, function (u, l) {
              !u && l.toString().trim()
                ? ((a.list = s(
                    l.toString().split(`
`),
...
function d0(t) {
  return new Promise((n) => {
    process.nextTick(() => {
      let e = [];
      ((t0 || r0 || s0 || o0) &&
        gs("lspci -vmm 2>/dev/null", function (s, r) {
          if (!s) {
            const o = l0();
            r.toString()
              .split(
...
`);
        ...
        n0 &&
          gs("system_profiler SPAudioDataType -json", function (s, r) {
            if (!s)
              try {
                const o = JSON.parse(r.toString());
                if (
...
async function np(t, n, e, i) {
  ...
  if (s.isDirectory() && Br(t, n)) throw new Error(Ti(t, n, e));
...
async function To(t, n, e, i) {
  ...
  if (jn(n, o)) throw new Error(Ti(t, e, i));
  return To(t, n, r, i);
}
function Do(t, n, e, i) {
  const s = ge.resolve(ge.dirname(t)),
...
async function ap(t, n, e = {}) {
  ...
  if ((await Rn.checkParentPaths(t, i, n, "copy"), !(await bo(t, n, e))))
    return;
...
async function lp(t, n, e, i, s) {
  ...
  if (s.overwrite) return (await xe.unlink(i), Cs(t, e, i, s));
...
async function pp(t, n, e, i, s) {
  ...
  for await (const o of await xe.opendir(e)) {
    const a = Wn.join(e, o.name),
      c = Wn.join(i, o.name);
    r.push(
      bo(a, c, s).then((u) => {
        if (u)
          return Rn.checkPaths(a, c, "copy", s).then(({ destStat: l }) =>
            Vo(l, a, c, s),
          );
      }),
    );
...
async function fp(t, n, e, i) {
  ...
  if (
    (i.dereference && (r = Wn.resolve(process.cwd(), r)), Rn.isSrcSubdir(s, r))
  )
...
function gp(t, n, e) {
  ...
  if (($n.checkParentPathsSync(t, i, n, "copy"), e.filter && !e.filter(t, n)))
    return;
...
function Op(t, n, e, i) {
  ...
  if ((i.dereference && (s = Gn.resolve(process.cwd(), s)), t)) {
    ...
    if (
      (i.dereference && (r = Gn.resolve(process.cwd(), r)),
      $n.isSrcSubdir(s, r))
    )
      throw new Error(
...
const { createFile: vs, createFileSync: _s } = Fp,
  { createLink: Os, createLinkSync: Ps } = zp,
  { createSymlink: Es, createSymlinkSync: Ms } = uf;
var pf = {
  // file
  createFile: vs,
  createFileSync: _s,
...
var Af = Mf;
const { stringify: Tf } = Wr,
  { outputFileSync: Df } = Rr;
function bf(t, n, e) {
  const i = Tf(n, e);
  Df(t, i, e);
}
...
async function Gf(t, n, e = {}) {
  const i = e.overwrite || e.clobber || !1,
    { srcStat: s, isChangingCase: r = !1 } = await Ts.checkPaths(
      t,
      n,
      "move",
      e,
...
function Kf(t, n, e) {
  e = e || {};
  const i = e.overwrite || e.clobber || !1,
    { srcStat: s, isChangingCase: r = !1 } = Ds.checkPathsSync(t, n, "move", e);
  return (
    Ds.checkParentPathsSync(t, s, n, "move"),
    Xf(n) || jf(cr.dirname(n)),
    qf(t, n, i, r)
  );
}
function Xf(t) {
...
class nd {
  ...
  createWindow() {
    ((this.mainWindow = new Qi({
      ...
      Zi.env.VITE_DEV_SERVER_URL
        ? this.mainWindow.loadURL(Zi.env.VITE_DEV_SERVER_URL)
